...
descr="Load waves!" 
tclcommand="xschem raw_read $netlist_dir/vco_tb_pex.raw tran"
}
...
.control
	...
	tran 10n 40000n
	let PERIOD=2.1e-6
	meas tran PERIOD TRIG vp0 VAL=0.5 RISE=5 TARG vp0 VAL=0.5 RISE=6
	meas tran vin_avg AVG vp0 from=1000n to=9000n

	meas tran vb_pfet_avg AVG vb_pfet from=1n to=9n
	meas tran vb_nfet_avg AVG vb_nfet from=1n to=9n
	remzerovec
	write vco_tb_pex.raw
	quit
.endc
"}
C {devices/launcher.sym} -190 -1290 0 0 {name=h1
descr="Simulate!"
...
.include /home/ttuser/ttsky26a-analog-voltage-controlled-oscillator/mag/vco.sim.spice
