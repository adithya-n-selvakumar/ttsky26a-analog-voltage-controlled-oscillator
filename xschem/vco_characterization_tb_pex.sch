...
descr="Load waves!" 
tclcommand="xschem raw_read $netlist_dir/vco_characterization_tb.pex_raw tran"
}
...
.option klu
.control
	echo 'i_in period vb_nfet vb_pfet' > vco_characterization_pex_tt_0.txt
	...
	while i_in_val <= 0.3e-3
		...
		echo $&i_in_val $&PERIOD $&vb_nfet_avg $&vb_pfet_avg >> vco_characterization_pex_tt_0.txt 
