...
N 80 -950 120 -950 {}
N 120 -1010 140 -1010 {}
C {devices/iopin.sym} -1050 -1210 0 0 {name=p3 lab=VDD}
C {devices/iopin.sym} -1050 -1170 0 0 {name=p15 lab=VSS}
C {devices/ipin.sym} -1070 -1210 0 0 {name=p1 lab=VB_PFET}
C {devices/ipin.sym} -1070 -1170 0 0 {name=p2 lab=VB_NFET}
C {devices/opin.sym} -960 -1240 0 0 {name=p45 lab=VP0}
C {devices/opin.sym} -960 -1210 0 0 {name=p46 lab=VP1}
C {devices/opin.sym} -960 -1180 0 0 {name=p47 lab=VP2}
C {devices/opin.sym} -960 -1150 0 0 {name=p48 lab=VP3}
C {devices/opin.sym} -880 -1240 0 0 {name=p61 lab=VN0}
C {devices/opin.sym} -880 -1210 0 0 {name=p62 lab=VN1}
C {devices/opin.sym} -880 -1180 0 0 {name=p63 lab=VN2}
C {devices/opin.sym} -880 -1150 0 0 {name=p64 lab=VN3}
...
C {devices/lab_pin.sym} -1080 -970 2 1 {name=p7 sig_type=std_logic lab=VB_PFET}
...
C {devices/lab_pin.sym} -1080 -930 2 1 {name=p10 sig_type=std_logic lab=VB_NFET}
...
C {devices/lab_pin.sym} -650 -970 2 1 {name=p5 sig_type=std_logic lab=VB_PFET}
C {devices/lab_pin.sym} -650 -930 2 1 {name=p12 sig_type=std_logic lab=VB_NFET}
C {devices/lab_pin.sym} -220 -970 2 1 {name=p13 sig_type=std_logic lab=VB_PFET}
C {devices/lab_pin.sym} -220 -930 2 1 {name=p14 sig_type=std_logic lab=VB_NFET}
C {devices/lab_pin.sym} 210 -970 2 1 {name=p18 sig_type=std_logic lab=VB_PFET}
C {devices/lab_pin.sym} 210 -930 2 1 {name=p19 sig_type=std_logic lab=VB_NFET}
